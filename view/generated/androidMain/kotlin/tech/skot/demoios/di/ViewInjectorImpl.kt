...
class ViewInjectorImpl : ViewInjector {
    ...
    override fun onTop(
        ...
        btnClose: SKButtonVC
    ): OnTopVC = OnTopViewProxy(
        visibilityListener, btnBurger as SKButtonViewProxy,
        btnClose as
            SKButtonViewProxy
    )
    override fun burgerScreen(
        ...
        loader: SKLoaderVC,
        toBasket: SKButtonVC
    ): BurgerScreenVC = BurgerScreenViewProxy(
        visibilityListener, burgerList as SKListViewProxy,
        loader
            as SKLoaderViewProxy,
        toBasket as SKButtonViewProxy
    )
