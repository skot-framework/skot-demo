...
class BurgerScreenViewProxy(
    ...
    override fun bindTo(
        ...
        burgerList._bindTo(activity, fragment, binding.burgerList)
        loader._bindTo(activity, fragment, binding.loader.root)
        toBasket._bindTo(activity, fragment, binding.toBasket)
    }
}
